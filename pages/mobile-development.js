...
const appDevelopment = () => {
  return (
    ...
    heading_para="At Himanstech, we create custom mobile apps with seamless user experience and interface design. Trust us to bring your app idea to life with stunning visuals and cutting-edge functionality. Contact us for a consultation"
    ...
    overview2_right_list1='i) requirements gathering'
    overview2_right_list2="ii) Design"
    overview2_right_list3="iii) Development"
    overview2_right_list4="iv) Testing"
    overview2_right_list5="v) Deployment"
    overview2_right_list6="vi) Maintenance"
    overview2_right_list7="vii) Security"
    />
    </Layout2>
    </>
  )
